...
import { Search, ArrowRight, Briefcase, BookOpen, Users, Shield, CheckCircle, TrendingUp } from 'lucide-react';
...
const Home = () => {
  ...
  const [stats, setStats] = useState({ applied: 0, saved: 0, views: 0, completed: 0 });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">Discover new opportunities and advance your creative career.</p>
            </div>
            <div className="bg-primary-50 p-4 rounded-xl flex items-center gap-4 w-full md:w-auto">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Update Your Skills</h3>
                <p className="text-xs text-gray-500">Enhance recommendations by refining your profile.</p>
              </div>
              <Link to="/me" className="ml-auto text-sm font-bold text-primary-600 hover:text-primary-700">
                Go
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div className="bg-purple-100 p-6 rounded-xl">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-medium text-purple-900">Applied Jobs</span>
              </div>
            ...
            <div className="bg-indigo-100 p-6 rounded-xl">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-medium text-indigo-900">Saved Courses</span>
              </div>
            ...
            <div className="bg-orange-100 p-6 rounded-xl">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-medium text-orange-900">Profile Views</span>
              </div>
            ...
            <div className="bg-teal-100 p-6 rounded-xl">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-medium text-teal-900">Completed Projects</span>
              </div>
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Top Recommended Opportunities</h2>
            {loading ? (
              <Loader />
            ) : (
  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative bg-gray-900 pt-20 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-200 mb-10">
            SkillMatch connects creative professionals with freelance jobs, courses, and tools to elevate their careers.
          </p>
      ...
      <div className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { icon: Search, title: 'Smart Job Matching', desc: 'Our AI-powered engine connects you with opportunities that fit your unique skills.' },
              { icon: TrendingUp, title: 'Skill Enhancement', desc: 'Access curated courses and resources to upskill and grow your career.' },
              { icon: Briefcase, title: 'Portfolio Showcase', desc: 'Build a stunning portfolio that highlights your best work and attracts clients.' },
              { icon: Users, title: 'Community & Support', desc: 'Join a vibrant network of creative professionals to collaborate and support.' },
            ].map((feature, index) => (
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-extrabold text-gray-900">How SkillMatch Works</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
             {[
               { step: 1, title: 'Create Your Profile', desc: 'Showcase your skills, experience, and portfolio to attract the right opportunities.' },
               { step: 2, title: 'Discover Opportunities', desc: 'Browse personalized job listings, courses, and tools matched to your profile.' },
               { step: 3, title: 'Grow Your Career', desc: 'Apply with confidence, collaborate, and achieve your professional goals.' }
             ].map((item) => (
      ...
      <div className="bg-gray-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
            Join SkillMatch today and unlock a world of opportunities tailored just for you.
          </p>
          <Link
            to="/signup"
