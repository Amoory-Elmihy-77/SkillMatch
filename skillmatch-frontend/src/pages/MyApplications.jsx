                                        ...
                                        <div className="flex-1">
                                            ...
                                            {application.notes && (
                                                <div className="mt-3 p-3 bg-gray-50 rounded-lg">
                                                    <p className="text-sm font-medium text-gray-700 mb-1">Notes from Reviewer:</p>
                                                    <p className="text-sm text-gray-600">{application.notes}</p>
                                                </div>
                                            )}
                                        </div>
                                        <div className={`flex items-center gap-2 px-4 py-2 rounded-lg border ${statusConfig.className}`}>
                                            {statusConfig.icon}
